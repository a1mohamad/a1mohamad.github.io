window.PROJECTS_DATA = [
  ...
  "desc": "End-to-end SMS spam classifier combining BiLSTM research and Optuna tuning with ONNX Runtime inference, a FastAPI API, encrypted PostgreSQL persistence, a React and TypeScript UI served by Nginx, Dockerized deployment on Render and Neon, automated Alembic migrations, testing, and GitHub Actions CI/CD.",
  "tools": [
    "Python",
    "TensorFlow/Keras",
    "ONNX",
...
window.PROJECTS = window.PROJECTS_DATA;
